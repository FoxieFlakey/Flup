...
#define _ckd_gnu_add_2(a, b, _)  __extension__({ \
...
#define _ckd_gnu_add_3(r, a, b)  __extension__({ \
		__auto_type _ckd_a = (a); \
		__auto_type _ckd_b = (b); \
...
#define _ckd_gnu_sub_2(a, b, _)  __extension__({ \
		__auto_type _ckd_a = (a); \
		__auto_type _ckd_b = (b); \
		__auto_type _ckd_ca = _ckd_toct(_ckd_a); \
		__auto_type _ckd_cb = _ckd_toct(_ckd_b); \
...
#define _ckd_gnu_sub_3(r, a, b)  __extension__({ \
		__auto_type _ckd_a = (a); \
		__auto_type _ckd_b = (b); \
		__auto_type _ckd_r = (r); \
		__auto_type _ckd_ca = _ckd_toct(_ckd_a); \
...
#define _ckd_gnu_mul_2(a, b, _)  __extension__({ \
		__auto_type _ckd_a = (a); \
		__auto_type _ckd_b = (b); \
		__auto_type _ckd_ca = _ckd_toct(_ckd_a); \
		__auto_type _ckd_cb = _ckd_toct(_ckd_b); \
...
#define _ckd_gnu_mul_3(r, a, b)  __extension__({ \
		__auto_type _ckd_a = (a); \
		__auto_type _ckd_b = (b); \
		__auto_type _ckd_r = (r); \
		__auto_type _ckd_ca = _ckd_toct(_ckd_a); \
