...
_ckd_fconst bool _ckd_ovf_signed_int(_ckd_S s1, _ckd_S s2, _ckd_S r) {
	return (s2 < 0 && s1 == INT_MIN) || (s2 && r / s2 != s1);
}
...
_ckd_fchpnt(3) bool _ckd_mul_sss_int(_ckd_U _ckd_S1, _ckd_U _ckd_S2, _ckd_U *_ckd_res) {
	*_ckd_res = _ckd_S1 * _ckd_S2;
	return _ckd_ovf_signed_int(_ckd_S1, _ckd_S2, *_ckd_res);
}
...
_ckd_fchpnt(3) bool _ckd_mul_sus_int(_ckd_U _ckd_S1, _ckd_U _ckd_U2, _ckd_U *_ckd_res) {
	*_ckd_res = _ckd_S1 * _ckd_U2;
	return (_ckd_S)_ckd_U2 >= 0 ? _ckd_ovf_signed_int(_ckd_S1, _ckd_U2, *_ckd_res)
...
_ckd_fchpnt(3) bool _ckd_mul_ssu_int(_ckd_U _ckd_S1, _ckd_U _ckd_S2, _ckd_U *_ckd_res) {
	...
	*_ckd_res = _t1 * _t2;
	return (_ckd_S)(_ckd_S1 ^ _ckd_S2) < 0 ? (_ckd_S1 && _ckd_S2) : _ckd_ovf_unsigned_int(_t1, _t2);
}
...
_ckd_fchpnt(1) bool _ckd_add_3_uint_to_char(char *_ckd_ret, _ckd_arg_uint _ckd_a, _ckd_arg_uint _ckd_b) {
	...
	const bool _ckd_of =
		...
		_ckd_add_int_choose_u(
			...
			|| _ckd_a._ckd_Overflow || _ckd_b._ckd_Overflow
#if CHAR_MAX == SCHAR_MAX
			|| (_ckd_S)_ckd_tmp > CHAR_MAX || (_ckd_S)_ckd_tmp < CHAR_MIN
#else
			|| _ckd_tmp > CHAR_MAX
#endif
			;
...
_ckd_fchpnt(1) bool _ckd_add_3_uint_to_schar(signed char *_ckd_ret, _ckd_arg_uint _ckd_a, _ckd_arg_uint _ckd_b) {
	...
	const bool _ckd_of =
		_ckd_add_int_choose_s(
			...
			|| _ckd_a._ckd_Overflow || _ckd_b._ckd_Overflow
#if 1
			|| (_ckd_S)_ckd_tmp > SCHAR_MAX || (_ckd_S)_ckd_tmp < SCHAR_MIN
#else
			|| _ckd_tmp > SCHAR_MAX
#endif
			;
...
#if 0
			|| (_ckd_S)_ckd_tmp > UCHAR_MAX || (_ckd_S)_ckd_tmp < 0
#else
			|| _ckd_tmp > UCHAR_MAX
#endif
#endif
...
_ckd_fchpnt(1) bool _ckd_add_3_uint_to_shrt(short *_ckd_ret, _ckd_arg_uint _ckd_a, _ckd_arg_uint _ckd_b) {
	...
	const bool _ckd_of =
		_ckd_add_int_choose_s(
			...
			|| _ckd_a._ckd_Overflow || _ckd_b._ckd_Overflow
#if 1
			|| (_ckd_S)_ckd_tmp > SHRT_MAX || (_ckd_S)_ckd_tmp < SHRT_MIN
#else
			|| _ckd_tmp > SHRT_MAX
#endif
			;
...
#if 0
			|| (_ckd_S)_ckd_tmp > USHRT_MAX || (_ckd_S)_ckd_tmp < 0
#else
			|| _ckd_tmp > USHRT_MAX
#endif
#endif
...
_ckd_fchpnt(1) bool _ckd_add_3_uint_to_int(int *_ckd_ret, _ckd_arg_uint _ckd_a, _ckd_arg_uint _ckd_b) {
	...
	const bool _ckd_of =
		_ckd_add_int_choose_s(
			...
			|| _ckd_a._ckd_Overflow || _ckd_b._ckd_Overflow
#if 1
			|| (_ckd_S)_ckd_tmp > INT_MAX || (_ckd_S)_ckd_tmp < INT_MIN
#else
			|| _ckd_tmp > INT_MAX
#endif
			;
...
#if 0
			|| (_ckd_S)_ckd_tmp > UINT_MAX || (_ckd_S)_ckd_tmp < 0
#else
			|| _ckd_tmp > UINT_MAX
#endif
#endif
...
_ckd_fconst bool _ckd_ovf_signed_long(_ckd_S s1, _ckd_S s2, _ckd_S r) {
	return (s2 < 0 && s1 == LONG_MIN) || (s2 && r / s2 != s1);
}
...
_ckd_fchpnt(3) bool _ckd_mul_sss_long(_ckd_U _ckd_S1, _ckd_U _ckd_S2, _ckd_U *_ckd_res) {
	*_ckd_res = _ckd_S1 * _ckd_S2;
	return _ckd_ovf_signed_long(_ckd_S1, _ckd_S2, *_ckd_res);
}
...
_ckd_fchpnt(3) bool _ckd_mul_sus_long(_ckd_U _ckd_S1, _ckd_U _ckd_U2, _ckd_U *_ckd_res) {
	*_ckd_res = _ckd_S1 * _ckd_U2;
	return (_ckd_S)_ckd_U2 >= 0 ? _ckd_ovf_signed_long(_ckd_S1, _ckd_U2, *_ckd_res)
		: (_ckd_S1 && ((_ckd_S)_ckd_S1 != -1 || _ckd_U2 != *_ckd_res));
}
...
_ckd_fchpnt(3) bool _ckd_mul_ssu_long(_ckd_U _ckd_S1, _ckd_U _ckd_S2, _ckd_U *_ckd_res) {
	...
	const _ckd_U _t2 = (_ckd_S)(_ckd_S1 & _ckd_S2) < 0 ? (-_ckd_S2) : _ckd_S2;
	*_ckd_res = _t1 * _t2;
	return (_ckd_S)(_ckd_S1 ^ _ckd_S2) < 0 ? (_ckd_S1 && _ckd_S2) : _ckd_ovf_unsigned_long(_t1, _t2);
}
...
_ckd_fchpnt(1) bool _ckd_add_3_ulong_to_long(long *_ckd_ret, _ckd_arg_ulong _ckd_a, _ckd_arg_ulong _ckd_b) {
	...
	const bool _ckd_of =
		_ckd_add_long_choose_s(
			...
			|| _ckd_a._ckd_Overflow || _ckd_b._ckd_Overflow
#if 1
			|| (_ckd_S)_ckd_tmp > LONG_MAX || (_ckd_S)_ckd_tmp < LONG_MIN
#else
			|| _ckd_tmp > LONG_MAX
#endif
			;
...
#if 0
			|| (_ckd_S)_ckd_tmp > ULONG_MAX || (_ckd_S)_ckd_tmp < 0
#else
			|| _ckd_tmp > ULONG_MAX
#endif
#endif
...
_ckd_fconst bool _ckd_ovf_signed_llong(_ckd_S s1, _ckd_S s2, _ckd_S r) {
	return (s2 < 0 && s1 == LLONG_MIN) || (s2 && r / s2 != s1);
}
...
_ckd_fchpnt(3) bool _ckd_mul_sss_llong(_ckd_U _ckd_S1, _ckd_U _ckd_S2, _ckd_U *_ckd_res) {
	*_ckd_res = _ckd_S1 * _ckd_S2;
	return _ckd_ovf_signed_llong(_ckd_S1, _ckd_S2, *_ckd_res);
}
...
_ckd_fchpnt(3) bool _ckd_mul_sus_llong(_ckd_U _ckd_S1, _ckd_U _ckd_U2, _ckd_U *_ckd_res) {
	*_ckd_res = _ckd_S1 * _ckd_U2;
	return (_ckd_S)_ckd_U2 >= 0 ? _ckd_ovf_signed_llong(_ckd_S1, _ckd_U2, *_ckd_res)
		: (_ckd_S1 && ((_ckd_S)_ckd_S1 != -1 || _ckd_U2 != *_ckd_res));
}
...
_ckd_fchpnt(3) bool _ckd_mul_ssu_llong(_ckd_U _ckd_S1, _ckd_U _ckd_S2, _ckd_U *_ckd_res) {
	...
	const _ckd_U _t2 = (_ckd_S)(_ckd_S1 & _ckd_S2) < 0 ? (-_ckd_S2) : _ckd_S2;
	*_ckd_res = _t1 * _t2;
	return (_ckd_S)(_ckd_S1 ^ _ckd_S2) < 0 ? (_ckd_S1 && _ckd_S2) : _ckd_ovf_unsigned_llong(_t1, _t2);
}
...
_ckd_fchpnt(1) bool _ckd_add_3_ullong_to_llong(long long *_ckd_ret, _ckd_arg_ullong _ckd_a, _ckd_arg_ullong _ckd_b) {
	...
	const bool _ckd_of =
		_ckd_add_llong_choose_s(
			...
			|| _ckd_a._ckd_Overflow || _ckd_b._ckd_Overflow
#if 1
			|| (_ckd_S)_ckd_tmp > LLONG_MAX || (_ckd_S)_ckd_tmp < LLONG_MIN
#else
			|| _ckd_tmp > LLONG_MAX
#endif
			;
...
#if 0
			|| (_ckd_S)_ckd_tmp > ULLONG_MAX || (_ckd_S)_ckd_tmp < 0
#else
			|| _ckd_tmp > ULLONG_MAX
#endif
#endif
...
_ckd_fconst bool _ckd_ovf_signed_int128(_ckd_S s1, _ckd_S s2, _ckd_S r) {
	return (s2 < 0 && s1 == INT128_MIN) || (s2 && r / s2 != s1);
}
...
_ckd_fchpnt(3) bool _ckd_mul_sss_int128(_ckd_U _ckd_S1, _ckd_U _ckd_S2, _ckd_U *_ckd_res) {
	*_ckd_res = _ckd_S1 * _ckd_S2;
	return _ckd_ovf_signed_int128(_ckd_S1, _ckd_S2, *_ckd_res);
}
...
_ckd_fchpnt(3) bool _ckd_mul_sus_int128(_ckd_U _ckd_S1, _ckd_U _ckd_U2, _ckd_U *_ckd_res) {
	*_ckd_res = _ckd_S1 * _ckd_U2;
	return (_ckd_S)_ckd_U2 >= 0 ? _ckd_ovf_signed_int128(_ckd_S1, _ckd_U2, *_ckd_res)
		: (_ckd_S1 && ((_ckd_S)_ckd_S1 != -1 || _ckd_U2 != *_ckd_res));
}
...
_ckd_fchpnt(3) bool _ckd_mul_ssu_int128(_ckd_U _ckd_S1, _ckd_U _ckd_S2, _ckd_U *_ckd_res) {
	...
	const _ckd_U _t2 = (_ckd_S)(_ckd_S1 & _ckd_S2) < 0 ? (-_ckd_S2) : _ckd_S2;
	*_ckd_res = _t1 * _t2;
	return (_ckd_S)(_ckd_S1 ^ _ckd_S2) < 0 ? (_ckd_S1 && _ckd_S2) : _ckd_ovf_unsigned_int128(_t1, _t2);
}
...
_ckd_fchpnt(1) bool _ckd_add_3_uint128_to_int128(__int128 *_ckd_ret, _ckd_arg_uint128 _ckd_a, _ckd_arg_uint128 _ckd_b) {
	...
	const bool _ckd_of =
		_ckd_add_int128_choose_s(
			...
			|| _ckd_a._ckd_Overflow || _ckd_b._ckd_Overflow
#if 1
			|| (_ckd_S)_ckd_tmp > INT128_MAX || (_ckd_S)_ckd_tmp < INT128_MIN
#else
			|| _ckd_tmp > INT128_MAX
#endif
			;
...
_ckd_fchpnt(1) bool _ckd_add_3_uint128_to_uint128(unsigned __int128 *_ckd_ret, _ckd_arg_uint128 _ckd_a, _ckd_arg_uint128 _ckd_b) {
	...
	const bool _ckd_of =
		_ckd_add_int128_choose_u(
			...
			|| _ckd_a._ckd_Overflow || _ckd_b._ckd_Overflow
#if 0
			|| (_ckd_S)_ckd_tmp > UINT128_MAX || (_ckd_S)_ckd_tmp < 0
#else
			|| _ckd_tmp > UINT128_MAX
#endif
			;
